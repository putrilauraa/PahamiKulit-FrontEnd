...
export default function BasicSkincareCleanser() {
            ...
            >
                ...
                <div className="mt-10 lg:mt-16">
                    ...
                    <div className="text-white bg-gradient-to-r from-[#7293D0] to-[#B5CBF0] mx-5 lg:mx-45 mb-8 lg:mb-16 rounded-2xl py-7 px-7 lg:py-10 lg:px-14">
                        ...
                        />
                        {/* Title */}
                        <h1 className="text-2xl lg:text-4xl font-bold lg:pb-2">Cleanser</h1>
                        {/* Slogan */}
                        <p className="lg:text-2xl lg:w-sm">Clear Skin Starts Here!</p>
                        {/* Product Description */}
                ...
                <div className="flex flex-col gap-3 mx-5 lg:mx-45 mt-8 lg:mt-16">
                    <h2 className="text-xl lg:text-3xl font-bold">Tipe Cleanser</h2>
