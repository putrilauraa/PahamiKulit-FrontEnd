...
export default function BasicSkincareSunscreen() {
        ...
        <>
            ...
            >
                ...
                <div className="mt-10 lg:mt-16">
                    ...
                    ></div>
                    <div className="absolute right-78 top-48">
                        <img
                            src="/Product-Sunscreen.png"
                            alt="Sunscreen"
                            className="hidden lg:block w-58 h-auto drop-shadow-[5px_5px_0px_rgba(0,0,0,0.15)]"
                        />
                    </div>
                    <div className="text-white bg-gradient-to-r from-[#7293D0] to-[#B5CBF0] mx-5 lg:mx-45 mb-8 lg:mb-16 rounded-2xl py-7 px-7 lg:py-10 lg:px-14">
                        <img
                            src="/Product-Sunscreen.png"
                            alt="Sunscreen"
                            className="block lg:hidden w-28 h-auto drop-shadow-[5px_5px_0px_rgba(0,0,0,0.15)] pb-3"
                        />
                        {/* Title */}
                        <h1 className="text-2xl lg:text-4xl font-bold lg:pb-2">Sunscreen</h1>
                        {/* Slogan */}
                        ...
                        <p className="text-xs lg:text-lg lg:w-3xl mt-2">
                            Sunscreen melindungi kulit dari efek merusak radiasi
                            matahari, seperti penuaan dini, hiperpigmentasi, dan
                            risiko kanker kulit. Penggunaan sunscreen secara
                            rutin terbukti mencegah kerusakan akibat sinar UV
                    ...
                    <div className="bg-white rounded-tr-2xl rounded-bl-2xl rounded-br-2xl py-4 px-5 lg:py-8 lg:px-10">
                        <div className="flex flex-col md:flex-row items-center gap-6">
                            ...
                            <div className="flex flex-col gap-3 lg:gap-4 lg:w-4xl text-xs lg:text-lg lg:ml-88">
                                {[
                                    'Melindungi kulit dari sinar UVB yang merupakan penyebab utama kulit terbakar',
                                    'Menghalangi sinar UVA yang berkontribusi terhadap penuaan dini',
                                    'Mengurangi risiko kanker kulit',
                                    'Mencegah hiperpigmentasi dengan menghalangi sinar UV',
                                ].map((item, index) => (
                                    <div
                                        key={index}
                ...
                <div className="mx-5 lg:mx-45 mt-8 lg:mt-16">
                    ...
                    <div className="bg-white rounded-tr-2xl rounded-bl-2xl rounded-br-2xl py-5 px-5 lg:py-12 lg:px-1">
                        <div className="relative">
                            ...
                            <div className="flex flex-col gap-3 lg:gap-6 relative z-10">
                                {[
                                    'Pilih sunscreen yang ditandai dengan adanya SPF dan PA, dengan minimal SPF 30',
                                    'Pastikan wajah dalam keadaan bersih sebelum menggunakan sunscreen',
                                    'Gunakan sunscreen dengan takaran 2 jari dan oleskan secara merata ke seluruh wajah dan leher',
                                    'Tunggu 15-30 menit sebelum terpapar sinar matahari',
                                ].map((text, i) => (
                                    <div
                                        key={i}
                        ...
                        <img
                            src="/Blue-2.png"
                            alt="Mascot"
                            className="hidden lg:block absolute bottom-4 right-58 top-290 w-68 h-auto -scale-x-100"
                        />
                        <img
                            src="/Elements-49.png"
                            alt="Mascot"
                            className="hidden lg:block absolute bottom-4 right-56 top-276 w-38 h-auto"
                        />
                    </div>
                </div>
                    ...
                    {[
                        {
                            ...
                            desc: 'Dikenal juga sebagai mineral sunscreen, bekerja dengan membentuk lapisan pelindung di permukaan kulit untuk memantulkan sinar UV.',
                            link: '/produk/gel-moisturizer',
                        },
                        {
                            title: 'Chemical Sunscreen',
                            desc: 'Menyerap sinar UV dan mengubahnya menjadi energi panas yang tidak berbahaya bagi kulit.',
                            link: '/produk/cream-moisturizer',
                        },
                        {
                            title: 'Hybrid Sunscreen',
                            desc: 'Sunscreen yang menggabungkan formula physical sunscreen dan chemical sunscreen, bertujuan untuk memberikan perlindungan lebih maksimal.',
