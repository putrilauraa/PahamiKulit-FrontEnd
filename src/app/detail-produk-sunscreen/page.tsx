                ...
                <div className="mt-16">
                    ...
                    <div className="absolute right-78 top-48">
                        <img
                            ...
                            alt="Sunscreen"
                            className="w-58 h-auto drop-shadow-[5px_5px_0px_rgba(0,0,0,0.15)]"
                        />
                    </div>
                    <div className="text-white bg-gradient-to-r from-[#7293D0] to-[#B5CBF0] mx-45 mb-16 rounded-2xl py-10 px-14">
                        {/* Title */}
                        <h1 className="text-4xl font-bold pb-2">Sunscreen</h1>
                        {/* Slogan */}
                ...
                <div className="mx-45 mt-16">
                    ...
                    <div className="bg-white rounded-tr-2xl rounded-bl-2xl rounded-br-2xl py-12 px-10">
                        ...
                        <img
                            src="/Blue-2.png"
                            alt="Mascot"
                            className="absolute bottom-4 right-58 top-290 w-68 h-auto -scale-x-100"
                        />
                        <img
                            src="/Elements-49.png"
                            alt="Mascot"
                            className="absolute bottom-4 right-56 top-276 w-38 h-auto"
                        />
                    </div>
                </div>
