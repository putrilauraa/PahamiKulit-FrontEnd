        ...
        <>
            ...
            <div className="text-white bg-gradient-to-t from-[#B5CBF0] to-[#7293D0] mx-35 mt-14 mb-60 rounded-2xl px-14 py-12">
                ...
                <p className="text-lg w-3xl">
                    Nah, kenalan dulu yuk sama empat produk basic skincare yang
                    wajib jadi teman sehari-hari kulitmu. Di halaman ini, kamu
                    bisa cari tahu fungsi masing-masing produk, cara penggunaan,
                    tipe-tipe produk, dan contoh produk lokalnya.
                </p>
            ...
            {/* Product Categories */}
            <div className="grid grid-cols-4 gap-4 mx-35 mb-30">
                <div
                ...
                >
                    <img
                        ...
                        alt="SPF"
                        className="absolute w-65 h-auto bottom-50 ml-10"
                    />
