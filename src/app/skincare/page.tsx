                ...
                <div className="grid grid-cols-1 md:grid-cols-2 grid-rows-4 md:grid-rows-2 gap-2 py-14 px-32 h-1/5">
                    ...
                    <div className="flex items-center">
                        <div className="border-[#FFD5E9] border-2 px-10 py-10 rounded-2xl hover:text-black hover:bg-[#FFD5E9]">
                            ...
                            <p>
                                ...
                                hingga melindungi kulit. Cocok untuk pemula yang
                                ingin mulai merawat kulit dengan cara yang
                                tepat.
                            </p>
                    ...
                    <div className="flex items-center">
                        <div className="border-[#BDD1F5] border-2 px-10 py-10 rounded-2xl hover:text-black hover:bg-[#BDD1F5]">
                            ...
                            <p>
                                ...
                                loh! Ada beberapa bahan aktif skincare yang
                                tidak boleh digunakan secara bersamaan, apa aja
                                ya kira-kira? Yuk cari tahu disini!
                            </p>
                    ...
                    <div className="flex items-center">
                        <div className="border-[#BDD1F5] border-2 px-10 py-10 rounded-2xl hover:text-black hover:bg-[#BDD1F5]">
                            ...
                            {/* Description */}
                            <p>
                                Dapatkan rekomendasi skincare terbaik untuk
                                jenis kulitmu. Mulai dari yang berminyak,
                                kering, sensitif, sampai berjerawat. Nggak perlu
                                repot tebak-tebakan lagi, semua info disajikan
                                dengan jelas, praktis, dan gampang dipahami.
                            </p>
                    ...
                    <div className="flex items-center">
                        <div className="border-[#FFD5E9] border-2 px-10 py-10 rounded-2xl hover:text-black hover:bg-[#FFD5E9]">
                            ...
                            {/* Description */}
                            <p>
                                Dukung kulit sehat sekaligus brand lokal! Di
                                sini kamu bisa menemukan berbagai rekomendasi
                                produk skincare buatan Indonesia yang nggak
                                kalah keren, aman, berkualitas, dan pastinya
                                lebih ramah di kantong dibandingkan dengan brand
                                skincare luar.
                            </p>
